        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Consumen <button id="btntambah" class="btn btn-primary float-right">Tambah Data</button></h4>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#data_table').DataTable({
            processing: true
            , serverSide: true
            , ajax: "{{ route(auth()->user()->role.'_consumen') }}"
            , columns: [{
                    data: null
                    , sortable: false
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route(auth()->user()->role.'_consumencreate') }}", //url simpan data
        ...
        $('body').on('click', '.delete', function(id) {
            ...
            var url = "{{ route(auth()->user()->role.'_consumendelete', ':dataid') }}";

            urls = url.replace(':dataid', dataid);
            alertify.confirm('Seluruh data yang berkaitan di consumen ini akan ikut terhapus, apa anda yakin ?', function() {
                $.ajax({
