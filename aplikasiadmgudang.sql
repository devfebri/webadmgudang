...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2024 at 08:53 AM
...
CREATE TABLE `item` (
  ...
  `sarial_number` varchar(255) NOT NULL,
...
INSERT INTO `item` (`id`, `supplier`, `nama_item`, `sarial_number`, `type`, `jenis`, `status`, `owner`, `created_at`, `updated_at`) VALUES
(1, '1', '1', '1', '1', '1', '1', '1', '2024-08-12 13:44:24', '2024-08-12 06:44:24');
