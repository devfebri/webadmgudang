angular.module("ngAlertify", []).factory("alertify", function () {
    ...
    !(function () {
        function e() {
            var t = {
                ...
                setup: function (t) {
                    ...
                    var i = o.querySelector(".ok"),
                        a = o.querySelector(".cancel"),
                        l = o.querySelector("input"),
                        r = o.querySelector("label");
                    l &&
                        ("string" == typeof this.promptPlaceholder &&
                            (r
                                ? (r.textContent = this.promptPlaceholder)
        ...
        if ("undefined" != typeof t && t && t.exports) {
            ...
            var i = new e();
            for (var a in i) t.exports[a] = i[a];
        } else
