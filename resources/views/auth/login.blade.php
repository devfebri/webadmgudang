...
<body class="fixed-left">
        ...
        <div class="" style="font-family:revert-layer;">
            <div class="card-body">
                <h3 class="text-center mt-0 m-b-15 animate__animated animate__rotateIn">
                    <img src="{{ asset('img/logo.png') }}" class="rounded-circle febri bg-white" height="100" alt="logo" data-tilt>
                </h3>
                <h3 style="font-family:Cursive;font-size:14pt;color:#fff;margin-bottom:-25px;" class="text-center animate__animated animate__fadeIn ">Administrasi Gudang PT Telkom Akses Jambi</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(this).toggleClass("active"), $(this).hasClass("active") ? ($("#password").attr("type", "text"), $(".text-show-password").html("Hide Password")) : ($("#password").attr("type", "password"), $(".text-show-password").html("Show Password"))
        });
